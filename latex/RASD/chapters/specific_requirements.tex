...
\section{Software system attribute}
  ...
  The system is completely automatized, so it will be available every day at every time, except for the night of the first wednesday, where the server will be disconnected due to maintenance or update.
  \subsection{Security}
