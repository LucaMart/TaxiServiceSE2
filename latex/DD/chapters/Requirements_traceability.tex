...
scan the list for a taxist to accept& 2.3.2 Controller, Ridesmanager, Ride\\ \hline
    ...
    G8& It is also neccessary to develop programmatic interfaces that allow to customize the system, adding new features& 2.5.1 Usege of third-party API\newline
															   2.5.3 In-house developed API\\ \hline
