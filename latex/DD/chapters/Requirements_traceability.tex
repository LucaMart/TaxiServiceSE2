...
scan the list for a taxist to accept& 2.3.2 Controller, Ridesmanager, Ride\\ \hline
	...
	amount every passenger have to pay& \\ \hline
    G7&When a driver is assigned to a non-shared ride, the system will send him the route he needs to follow, and the fee
	amount the passenger has to pay& \\ \hline
    G8& It is also neccessary to develop programmatic interfaces that allow to customize the system, adding new features& \\ \hline
 \end{longtable}
\end{center}
